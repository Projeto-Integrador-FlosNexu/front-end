        ...
        <div className=' w-72 '>
            <div className='flex flex-col rounded-lg overflow-hidden justify-between bg-white' >
                <div className='py-4'>
                    ...
                    <img src={item.foto} className='mt-1 h-40 w-75 mx-auto' alt={item.nome} />
                ...
                <td>
                    <div className='qty ml-[50px] mt-[-40px]'>
                        ...
                        <button className=' w-10 text-slate-100 mt-[-40px] bg-red-500 hover:bg-red-700 
                                   flex items-center justify-center py-2'
                            onClick={() => {
                ...
                <td className=" ml-[70px] mb-[10px] mt-[-40px]">R$ {item.preco * item.quantidade}</td>

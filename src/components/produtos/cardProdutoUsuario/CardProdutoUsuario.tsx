        ...
        <a href="#">
          ...
          <div className="px-4 py-3 w-72">
            ...
            <div className="flex items-center">
              ...
              <div  onClick={() => adicionarProdutos(produto)} className="ml-auto bg-[#FD98B4] p-2 rounded-full"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-bag-plus" viewBox="0 0 16 16">

                ...
                <ul className='caixanav'>
                  ...
                  <div className="dropdown">
                    ...
                    <div className="dropdown-content ">
                       <Link to='/produtos' className='hover:text-[#82d338] hover:underline'>Painel Solar</a>
                       <Link to='/produtos' className='hover:text-[#82d338] hover:underline'>Bateria Solar</a>
                      <Link to='/produtos' className='hover:text-[#82d338] hover:underline'>Materias de Construção</a>
                      <Link to='/produtos' className='hover:text-[#82d338] hover:underline'>Outros</a>
                    </div>
                  </div>
              ...
              <div className='caixanav' >
                <ul className='caixanav'>
                  ...
                  <div className="dropdown font-bold">
                    ...
                    <div className="dropdown-content">
                      <Link to='/produtos' className='hover:bg-[#82d338] hover:underline'>Painel Solar</a>
                      <Link to='/produtos' className='hover:bg-[#82d338] hover:underline'>Bateria Solar</a>
                      <Link to='/produtos' className='hover:bg-[#82d338] hover:underline'>Materias de Construção</a>
                      <Link to='/produtos' className='hover:bg-[#82d338] hover:underline'>Outros</a>
                    </div>
                  </div>
                  <Link to='/servicos' className='servico text-3xl'>SERVIÇOS</Link>
                  <Link to='/about' className=' sobre text-3xl'>SOBRE</Link>
